(function() {
  ...
  css.textContent = [
    ...
    // Nav style normalization (match partner page)
  ...
  if (nav) {
    ...
    hamburger.className = 'roi-hamburger';
  ...
  var footer = wrapper.querySelector('.p3-footer') || wrapper.querySelector('footer') || null;
  if (footer) {
    wrapper.insertBefore(roiPage, footer);
  } else {
